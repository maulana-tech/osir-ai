...
class Workspace(models.Model):
    ...
    class AgentAutonomy(models.TextChoices):
        OFF = "off", "Off"
    ...
    # How much the Osir AI autopilot may do on its own. Read by the agent at
    # the start of every run; the API key's permissions remain the hard gate.
    agent_autonomy = models.CharField(
        max_length=20,
        choices=AgentAutonomy.choices,
        default=AgentAutonomy.DRAFT_ONLY,
    )
